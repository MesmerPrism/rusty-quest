...
final class NativeRendererForegroundGuardPolicy {
    ...
    static String visibleOwnedComponent(boolean panelFocused, boolean immersiveFocused) {
        if (panelFocused) return CONTROL_PANEL_ACTIVITY;
        if (immersiveFocused) return NATIVE_ACTIVITY;
        return null;
    }
