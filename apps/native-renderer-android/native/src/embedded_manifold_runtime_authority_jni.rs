//! Embedded Android JNI bridge to the shared Manifold authority evaluator.

pub(crate) fn evaluate_for_host_test(invocation_json: &str) -> Result<String, String> {
...
#[no_mangle]
pub extern "system" fn Java_io_github_mesmerprism_rustyquest_native_1renderer_EmbeddedManifoldRuntimeAuthorityBridge_nativeEvaluate(
...
mod tests {
    ...
    #[test]
    fn embedded_native_boundary_preserves_manifold_response() {
