...
internal data class VrStrobeSafetySnapshot(
    ...
    val depthDeformationAvailable: Boolean = false,
    val depthDeformationEnabled: Boolean = false,
    val depthDeformationEffective: Boolean = false,
    val depthMaxDisplacementMeters: Float =
        VrStrobeDepthDeformationPolicy.DEFAULT_MAX_METERS,
