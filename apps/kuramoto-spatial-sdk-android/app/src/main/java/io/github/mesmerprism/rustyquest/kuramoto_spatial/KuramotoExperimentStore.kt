    ...
    private val CONDITIONS =
        listOf(
            Condition(
                ...
                profileId = "rusty.quest.kuramoto_spatial.condition.low-energy-low-coherence.movement-only.v1",
                movementBaseHz = 0.44,
            ...
            Condition(
                ...
                profileId = "rusty.quest.kuramoto_spatial.condition.high-energy-low-coherence.movement-only.v1",
                movementBaseHz = 0.88,
                movementCoupling = 0.0,
            ),
            Condition(
                ...
                profileId = "rusty.quest.kuramoto_spatial.condition.low-energy-high-coherence.movement-only.v1",
                movementBaseHz = 0.44,
            ...
            Condition(
                ...
                profileId = "rusty.quest.kuramoto_spatial.condition.high-energy-high-coherence.movement-only.v1",
                movementBaseHz = 0.88,
                movementCoupling = 1.0,
            ),
        )
