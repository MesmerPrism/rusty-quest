...
final class PolarSensorPanel {
    ...
    private static final String TAG = "RQKuramotoSpatial";
    private static final String MARKER_PREFIX = "RUSTY_QUEST_KURAMOTO_SPATIAL";
    ...
    private void writeStatus(String state, String detail) {
        try {
            JSONObject body = new JSONObject()
                .put("schema", "rusty.quest.kuramoto_spatial.polar_sensor_status.v1")
                .put("status", state)
