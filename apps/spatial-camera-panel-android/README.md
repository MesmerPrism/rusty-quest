...
- `app/src/main/.../SpatialDiagnosticProbeRouteModule.kt` owns the
  ...
  marker fields and SDK-owned quad surface probe lifecycle marker fields. It
  must not create scene objects, draw surfaces, call JNI, or mutate Activity
  probe state.
