...
const PUBLIC_HAND_ANCHOR_DRIVER_PROFILE_ID: &str = "profile-b";
const PUBLIC_HAND_ANCHOR_PROFILE_ID: &str =
    "rusty.quest.spatial_camera_panel.driver_profile.profile-b.v1";
const PUBLIC_HAND_ANCHOR_DYNAMICS_MODE: &str = "public-driver-profile-b";
const PUBLIC_HAND_ANCHOR_DRIVER_BASE_HZ: f32 = 0.88;
const PUBLIC_HAND_ANCHOR_DRIVER_MIX_01: f32 = 0.0;
const PUBLIC_HAND_ANCHOR_FREQUENCY_SPREAD_HZ: f32 = 0.62;
const PUBLIC_HAND_ANCHOR_NOISE_AMPLITUDE_METERS: f32 = 0.004;
const PUBLIC_HAND_ANCHOR_NOISE_SPEED_HZ: f32 = 0.50;
...
impl ReplayHandsStats {
    ...
    fn stats_marker_fields(&self) -> String {
        format!(
            ...
            PUBLIC_HAND_ANCHOR_FREQUENCY_SPREAD_HZ,
            PUBLIC_HAND_ANCHOR_NOISE_AMPLITUDE_METERS,
            PUBLIC_HAND_ANCHOR_NOISE_SPEED_HZ,
            self.left_frames,
            self.right_frames,
...
impl ReplayHandsRenderer {
    pub(crate) unsafe fn new(
        ...
        android_log_info(
            ...
            &format!(
                "RUSTY_QUEST_SPATIAL_CAMERA_PANEL_NATIVE channel=native-surface-particle-layer status=native-hand-anchor-particles-ready renderPolicy=native-vulkan-wsi-surface-panel {}",
                stats.marker_fields(),
            ),
        );
        android_log_info(
            "RQSpatialCameraPanelNative",
            &format!(
                "RUSTY_QUEST_SPATIAL_CAMERA_PANEL_NATIVE channel=native-surface-particle-layer status=native-hand-anchor-particles-stats renderPolicy=native-vulkan-wsi-surface-panel {}",
        ...
        android_log_info(
            "RQSpatialCameraPanelNative",
            &format!(
                "RUSTY_QUEST_SPATIAL_CAMERA_PANEL_NATIVE channel=native-surface-particle-layer status=native-hand-anchor-mesh-components renderPolicy=native-vulkan-wsi-surface-panel {}",
        ...
        android_log_info(
            "RQSpatialCameraPanelNative",
            &format!(
                "RUSTY_QUEST_SPATIAL_CAMERA_PANEL_NATIVE channel=native-surface-particle-layer status=native-hand-anchor-left-hand-mesh-components renderPolicy=native-vulkan-wsi-surface-panel liveMeshSurfacePolicy={} liveMeshWristCapPolicy=drop-component-rank-2 {}",
                marker_token(HAND_MESH_COMPONENT_POLICY),
        ...
        android_log_info(
            "RQSpatialCameraPanelNative",
            &format!(
                "RUSTY_QUEST_SPATIAL_CAMERA_PANEL_NATIVE channel=native-surface-particle-layer status=native-hand-anchor-right-hand-mesh-components renderPolicy=native-vulkan-wsi-surface-panel liveMeshSurfacePolicy={} liveMeshWristCapPolicy=drop-component-rank-2 {}",
                marker_token(HAND_MESH_COMPONENT_POLICY),
        ...
        android_log_info(
            "RQSpatialCameraPanelNative",
            &format!(
                "RUSTY_QUEST_SPATIAL_CAMERA_PANEL_NATIVE channel=native-surface-particle-layer status=live-hand-joint-particle-source-ready renderPolicy=native-vulkan-wsi-surface-panel {} {} liveHandJointBufferRows={} liveHandJointBufferBytes={}",
        ...
        for (hand_index, draw) in self.draws.iter().enumerate() {
            ...
            let push = ReplayHandPush {
                ...
                projection: [
                    ...
                    PUBLIC_HAND_ANCHOR_PARTICLE_RADIUS_METERS,
                ],
                color: [
                ...
                profile: [
                    PUBLIC_HAND_ANCHOR_FREQUENCY_SPREAD_HZ,
                    PUBLIC_HAND_ANCHOR_NOISE_AMPLITUDE_METERS * driver0_value01.clamp(0.0, 1.0),
                    PUBLIC_HAND_ANCHOR_NOISE_SPEED_HZ,
    ...
    fn from_source(source: &ReplayHandSource) -> Result<Self, String> {
        ...
        for hand in [&source.left, &source.right] {
            ...
            draws.push(ReplayHandDraw {
                ...
                vertices_per_frame,
                triangles_per_frame,
                particles_per_frame: PUBLIC_HAND_ANCHOR_PARTICLES_PER_HAND,
            ...
            match hand.handedness.as_str() {
                "right" => {
                    ...
                    right_particles_per_frame = PUBLIC_HAND_ANCHOR_PARTICLES_PER_HAND;
                }
                _ => {
                    left_vertices_per_frame = vertices_per_frame;
                    left_triangles_per_frame = triangles_per_frame;
                    left_particles_per_frame = PUBLIC_HAND_ANCHOR_PARTICLES_PER_HAND;
                }
            }
        }
