...
impl CameraProjectionCadenceAuthority {
    fn marker_token(self) -> &'static str {
        match self {
            Self::SpatialSdkBrokerRetired => "spatial-sdk-broker-retired-fence-complete",
    ...
    fn session_authority(self) -> &'static str {
        match self {
            Self::SpatialSdkBrokerRetired => "spatial-sdk-device-binding",
    ...
    fn present_authority(self) -> &'static str {
        match self {
            Self::SpatialSdkBrokerRetired => "app-submit-ordinal-retired-by-sdk-broker",
            Self::VulkanWsiPresentReturned => "vulkan-wsi-queue-present-returned",
        }
    }
}
...
mod tests {
    ...
    fn sample(present_ordinal: u64) -> CameraProjectionFreshnessSample {
        CameraProjectionFreshnessSample {
            ...
            cadence_authority: CameraProjectionCadenceAuthority::SpatialSdkBrokerRetired,
    ...
    #[test]
    fn live_layer_removal_between_submission_and_retirement_latches_rejection() {
