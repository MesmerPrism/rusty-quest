...
internal data class SpatialControllerPrimarySnapshot(
    ...
    val localLeftControllerAttachmentType: String,
    val localLeftControllerActive: Boolean,
    val localLeftControllerButtonState: Int,
    val localLeftControllerChangedButtons: Int,
    ...
    val leftThumbLeft: Boolean,
    val leftThumbRight: Boolean,
    val leftThumbX: Float,
    val leftThumbY: Float,
    val rightThumbUp: Boolean,
    val rightThumbDown: Boolean,
    val rightThumbLeft: Boolean,
    val rightThumbRight: Boolean,
    val rightThumbX: Float,
    ...
    val leftPrimaryDown: Boolean,
    val leftPrimaryPressed: Boolean,
)
