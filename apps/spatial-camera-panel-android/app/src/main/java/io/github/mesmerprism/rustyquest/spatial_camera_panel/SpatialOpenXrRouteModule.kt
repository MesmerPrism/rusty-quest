...
private const val XR_KHR_CONVERT_TIMESPEC_TIME_EXTENSION = "XR_KHR_convert_timespec_time"
private val SPATIAL_PASSTHROUGH_REQUIRED_OPENXR_EXTENSIONS =
    listOf(
        XR_FB_PASSTHROUGH_EXTENSION,
        XR_META_ENVIRONMENT_DEPTH_EXTENSION,
        XR_KHR_CONVERT_TIMESPEC_TIME_EXTENSION,
    )
