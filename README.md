...
it is not a reusable runtime admission or publication authority. Its GitHub
synthetic merge SHA is observation only: the one-time readback instead requires
the exact base/head commits and trees, generated tree, ordered parents, and
complete artifact inventory/digest.
