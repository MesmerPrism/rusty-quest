...
$polarJavaRoot = Join-Path $appRoot "panel-modules\polar\src\main\java\io\github\mesmerprism\rustyquest\native_renderer"
$manifest = Read-RequiredText (Join-Path $appRoot "AndroidManifest.xml") "Android manifest"
$controlPanel = Read-RequiredText (Join-Path $appRoot "panel-modules\breath-composition\src\main\java\io\github\mesmerprism\rustyquest\native_renderer\BreathCompositionPanelModule.java") "control panel"
$polarPanel = Read-RequiredText (Join-Path $polarJavaRoot "PolarSensorPanel.java") "Polar panel"
$polarRuntime = Read-RequiredText (Join-Path $polarJavaRoot "PolarSensorRuntime.java") "headless Polar runtime"
$polarReceiver = Read-RequiredText (Join-Path $polarJavaRoot "PolarSensorCommandReceiver.java") "headless Polar receiver"
$polarRuntimeSupport = Read-RequiredText (Join-Path $polarJavaRoot "PolarBleRuntimeSupport.java") "Polar runtime support"
