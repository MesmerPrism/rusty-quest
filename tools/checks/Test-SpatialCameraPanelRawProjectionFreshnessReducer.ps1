...
function New-Marker {
    ...
    return "schema=rusty.quest.camera_hwb_projection_freshness_receipt.v1 " +
        ...
        "sessionGeneration=31 sessionGenerationAuthority=spatial-sdk-device-binding " +
        "cadenceAuthority=spatial-sdk-broker-retired-fence-complete cadenceAvailable=true " +
        "previousCadenceOrdinal=$PreviousPresent currentCadenceOrdinal=$CurrentPresent " +
        "presentOrdinalAuthority=app-submit-ordinal-retired-by-sdk-broker " +
...
function Invoke-Reducer {
    ...
    & $Reducer `
        ...
        -ExpectedCadenceAuthority spatial-sdk-broker-retired-fence-complete `
