...
if ($manifest.property_count -ne 116 -or $manifest.properties.Count -ne 116) {
    throw "Native renderer property manifest must cover the current 116-property runtime surface."
}
