...
Assert-Contains "Activity" $activity "stereoHorizontalOffsetJoystickInput=disabled-default-locked-left-stick-y-controls-panel-distance-private-free-transform"
...
Assert-Contains "Activity" $activity "privateLayerPanelTransformAuthority=spatial-sdk-grabbable-free-transform"
...
Assert-Contains "Activity" $activity "privateLayerPanelPoseSource=initial-headset-facing-world-space-then-sdk-owned"
Assert-Contains "Activity" $activity "privateLayerPanelDistanceMode=disabled-sdk-free-transform"
Assert-Contains "Activity" $activity "privateLayerPanelForcedDistanceDisabled=true"
Assert-Contains "Activity" $activity "privateLayerPanelDistanceControl=left-stick-y-free-transform-distance"
Assert-Contains "Activity" $activity "private-layer-free-transform-distance-joystick-adjusted"
Assert-Contains "Activity" $activity "private-layer-free-transform-distance-joystick-skipped"
...
Assert-Contains "README" $readme "Spatial-SDK-owned free transform mode"
Assert-Contains "README" $readme "left-stick Y now nudges"
...
Assert-Contains "Implementation notes" $notes "Spatial SDK mesh"
...
Assert-Contains "Implementation notes" $notes "direct distance nudge"
