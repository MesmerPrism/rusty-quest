...
Assert-Contains "Native receipt build script" $nativeBuildScript 'PRIVATE_SURFACE_PARTICLE_MASK_TEXTURE_MODE: &str = \"texture-array-nearest\"'
...
$openXrMappedFallbackIndex = $surfaceLayer.IndexOf("SURFACE_PARTICLE_OPENXR_WORLD_ANCHOR_MAPPED_VALID", $anchorPriorityFunctionIndex)
...
if ($openXrMappedFallbackIndex -ge 0) {
    throw "Surface particle world-anchor selection must not use the OpenXR-mapped diagnostic anchor as active compute authority."
}
...
Assert-Contains "Surface particle layer" $surfaceLayer "privateSurfaceParticleOpenXrViewDrawAuthority=true"
...
Assert-Contains "Surface particle layer" $surfaceLayer "privateSurfaceParticleMainDrawCameraBasisSource=OpenXR-xrLocateViews-mapped-to-spatial-world-with-scene-tick-fallback+forward-x-mirror-corrected-roll-stable"
...
Assert-Contains "Surface particle layer" $surfaceLayer "privateSurfaceParticleEyePoseSource=OpenXR-xrLocateViews-per-frame-mapped-to-spatial-world"
Assert-Contains "Surface particle layer" $surfaceLayer "privateSurfaceParticleCameraPoseCadence=render-loop-openxr-locateviews"
Assert-Contains "Surface particle layer" $surfaceLayer "privateSurfaceParticleSceneTickPoseFallback=true"
Assert-Contains "Surface particle layer" $surfaceLayer "SURFACE_PARTICLE_OPENXR_VIEWER_EYE_POSE_ACTIVE"
Assert-Contains "Surface particle layer" $surfaceLayer "privateSurfaceParticleSceneTickViewerEyePoseStored="
...
Assert-Contains "Surface particle layer" $surfaceLayer "privateSurfaceParticleMaskTextureMode=texture-array-nearest"
...
Assert-Contains "Particle visual smoke" $particleVisualSmoke "privateSurfaceParticleMainDrawCameraBasisSource=OpenXR-xrLocateViews-mapped-to-spatial-world-with-scene-tick-fallback+forward-x-mirror-corrected-roll-stable"
...
Assert-Contains "Particle visual smoke" $particleVisualSmoke "privateSurfaceParticleEyePoseSource=OpenXR-xrLocateViews-per-frame-mapped-to-spatial-world"
Assert-Contains "Particle visual smoke" $particleVisualSmoke "privateSurfaceParticleCameraPoseCadence=render-loop-openxr-locateviews"
Assert-Contains "Particle visual smoke" $particleVisualSmoke "privateSurfaceParticleSceneTickPoseFallback=true"
...
Assert-Contains "Particle visual smoke" $particleVisualSmoke "privateSurfaceParticleOpenXrViewDrawAuthority=true"
...
Assert-Contains "Surface private particles fragment shader" $privateSurfaceParticlesFrag "PRIVATE_PARTICLE_MASK_TEXTURE_MODE_CODE 1"
...
Assert-Contains "Surface private particles fragment shader" $privateSurfaceParticlesFrag "outColor = vec4(rgb * outputAlpha, outputAlpha)"
