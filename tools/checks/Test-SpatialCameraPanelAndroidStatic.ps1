...
Assert-Contains "Activity" $activity "PARTICLE_LAYER_CARRIER_DEFAULT = `"manual-panel-scene-object-custom-mesh`""
...
Assert-Contains "Activity" $activity "spatial-sdk-manual-panel-scene-object-android-surface"
...
Assert-Contains "Activity" $activity "PARTICLE_LAYER_HEIGHT_METERS = 4.00f"
Assert-Contains "Activity" $activity "PARTICLE_LAYER_HORIZONTAL_FOV_SCALE"
Assert-Contains "Activity" $activity "PARTICLE_LAYER_WIDTH_MAX_METERS = 5.40f"
Assert-Contains "Activity" $activity "PARTICLE_LAYER_HEIGHT_MAX_METERS = 4.00f"
Assert-Contains "Activity" $activity "PARTICLE_LAYER_SURFACE_WIDTH_MAX_METERS = 5.40f"
Assert-Contains "Activity" $activity "PARTICLE_LAYER_SURFACE_HEIGHT_MAX_METERS = 4.00f"
Assert-Contains "Activity" $activity "PARTICLE_LAYER_SURFACE_OVERSCAN_SCALE = 1.00f"
Assert-Contains "Activity" $activity "PARTICLE_LAYER_SURFACE_OVERSCAN_MAX_SCALE = 1.00f"
Assert-Contains "Activity" $activity "particleLayerProjectionSurfaceMarkerFields"
Assert-Contains "Activity" $activity "overscanMode=none"
Assert-Contains "Activity" $activity "projectionSurfaceScaleX="
Assert-Contains "Activity" $activity "projectionSurfaceScaleY="
Assert-Contains "Activity" $activity "panelDimensionsMatchProjection="
Assert-Contains "Activity" $activity "overscanCompensated=not-required"
Assert-Contains "Activity" $activity "horizontalProjectionMode=wide-fov"
Assert-Contains "Activity" $activity "projectionHorizontalScale="
...
Assert-Contains "Activity" $activity "PARTICLE_LAYER_PANEL_LAYER_CHECK_INTERVAL_MS"
