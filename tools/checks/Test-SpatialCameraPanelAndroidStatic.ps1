...
Assert-Contains "README" $readme "raw-projection startup/swapchain/native-start marker fields"
...
Assert-Contains "Implementation notes" $notes "raw-projection startup/swapchain/native-start marker fields"
