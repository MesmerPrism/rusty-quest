...
Assert-Contains "Activity" $activity "PanelShapeLayerBlendType.OPAQUE"
...
Assert-Contains "README" $readme "layer config enabled"
Assert-Contains "README" $readme "privateLayerPanelLayerZIndex"
...
Assert-Contains "Implementation notes" $notes "Spatial SDK layer-backed"
