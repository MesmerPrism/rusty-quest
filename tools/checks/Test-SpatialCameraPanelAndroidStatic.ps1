...
Assert-Contains "Activity" $activity "SpatialOpenXrRouteModule.spatialEnvironmentDepthProviderStarted"
Assert-Contains "Activity" $activity "SpatialOpenXrRouteModule.spatialEnvironmentDepthAcquireThreadStarted"
