...
Assert-Contains "Immersive session" $session "HEAD_FIXED_VIDEO_COVER_OVERSCAN_SCALE = 1.10f"
...
Assert-Contains "Immersive session tests" $sessionTest "directVideoCoverageTargetMeters=6.0885x4.5100"
Assert-Contains "Immersive session tests" $sessionTest "directVideoCoverageOverscanScale=1.1000"
