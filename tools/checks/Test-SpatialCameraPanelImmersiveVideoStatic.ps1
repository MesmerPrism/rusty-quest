...
Assert-Contains "Immersive session" $session "PARTICLE_LAYER_WIDTH_METERS * distanceScale"
Assert-Contains "Immersive session" $session "PARTICLE_LAYER_HEIGHT_METERS * distanceScale"
Assert-Contains "Immersive session tests" $sessionTest "headFixedTopBottomDirectPanelKeepsTopLeftAndBottomRightEyeCrops"
...
Assert-Contains "Immersive session tests" $sessionTest "directVideoCoverageTargetMeters=5.5350x4.1000"
...
Assert-Contains "Native video cache" $nativeVideoSettings "import_cache_never_retains_more_buffers_than_the_configured_reader_queue"
Assert-Contains "Native video cache" $nativeVideoSettings "max_images.clamp(2, 6) as usize"
