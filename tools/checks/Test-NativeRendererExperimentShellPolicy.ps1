...
Assert-NotContains $buildPath 'NativeRendererSelfKioskApplication.beginSystemPrompt(activity)'
Assert-NotContains $buildPath 'Settings.ACTION_MANAGE_OVERLAY_PERMISSION'
