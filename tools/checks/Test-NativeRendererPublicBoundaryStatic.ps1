...
if ($SourcePaths.Count -eq 0) {
    ...
    $SourcePaths = @(
        ...
        (Join-Path $appRoot "native\shaders\guide_video_projection.frag.glsl"),
        ...
        (Join-Path $appRoot "native\src\native_renderer_passthrough_style_options.rs"),
        ...
        (Join-Path $appRoot "native\src\gpu_private_particles.rs"),
        (Join-Path $appRoot "native\shaders\hand_mesh_visual.vert.glsl"),
        (Join-Path $appRoot "native\shaders\hand_mesh_visual.frag.glsl"),
        (Join-Path $appRoot "native\shaders\private_particles.vert.glsl"),
        (Join-Path $appRoot "native\shaders\private_particles.frag.glsl"),
        (Join-Path $appRoot "native\shaders\private_particles_placeholder.comp.glsl"),
        ...
        (Join-Path $appRoot "native\src\openxr_passthrough_style.rs"),
