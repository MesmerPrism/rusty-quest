...
$qcl100Runner = @(
    ...
    Read-RepoText "tools\Invoke-Qcl100QuestToQuestNativeStereoProjectionWifiDirectMonitored.ps1"
...
foreach ($token in @(
    ...
    "Get-RustyQuestQcl041WifiDirectGroupOwnerAddress",
    ...
    "Get-Qcl100DirectP2pAddressRefresh",
    "rusty_direct_p2p_socket_authority",
    "direct_p2p_media_authority",
    "direct_p2p_address_refresh",
    "Get-Qcl100DirectP2pSenderAuthority",
    "direct_p2p_media_ready",
    "direct_p2p_native_projection_ready",
    "owner_direct_p2p_sender_authority",
    "client_direct_p2p_sender_authority",
    "owner_direct_p2p_sender_authority_not_accepted",
    "client_direct_p2p_sender_authority_not_accepted",
    "peer_socket_authority",
    "peer_socket_wifi_direct_bind_required",
    "peer_socket_local_address_same_subnet",
    "qcl100-monitor-progress.jsonl",
    "Get-Qcl100LatestEvidenceFileSummary",
    "qcl100-monitor-wrapper.stdout.txt",
    "latest_evidence_file",
    "latest_any_write_utc",
    "OverallTimeoutSeconds",
    "PhaseStallTimeoutSeconds",
    "LiveBridgeCommandTimeoutSeconds",
    "rusty.quest.qcl100_live_bridge_command_attempt.v1",
    "Write-LiveBridgeCommandAttemptReceipt",
    "Get-LiveBridgeCommandExecutionIssueSummary",
    "execution.command_execution.issues",
    " Issues: ",
    "--websocket-ready-wait-seconds",
    "--launch-settle-seconds",
    "--runtime-subscriber-retry-count",
    "--runtime-subscriber-retry-wait-seconds",
    "*-live-command-attempt.json",
    "Get-Qcl100LiveBridgeCommandAttemptReceipts",
    "Get-Qcl100LatestLiveBridgeCommandAttempt",
    "latest_live_bridge_command_attempt",
    "live_bridge_command_timeout_seconds",
    "broker_sender_start_attempted",
    "rusty.quest.qcl100_direct_p2p_address_refresh_attempt.v1",
    "qcl100-direct-p2p-address-refresh-attempt.json",
    "direct_p2p_address_refresh_running",
    "qcl100-qcl041-relays-launched.json",
    "rusty.quest.qcl100_qcl041_relay_launch_stage.v1",
    "runnerWorkingDirectory",
    "phase_stall_timeout",
    "Save-Qcl041DeviceArtifact",
    "Read-Qcl100DeviceState",
    "qcl041_device_artifacts",
    "post_cleanup_device_state",
    "infrastructure_connected",
    "ipv4_present",
    "Write-Host",
    "transport_bind_local_address",
    "New-Qcl100ReceiverParams",
    "Assert-Qcl100ReceiverReady",
    "receiver_ready",
    "owner_receiver_transport_bind_host",
    "client_receiver_transport_bind_host",
    "receiver_bind_policy",
    ...
    "left-only",
    "right-only",
    "Read-RustyQuestAdbAppFile",
    "Save-RustyQuestJsonArtifactFromStdout",
    "qcl041_json_stdout_accepted_with_nonzero_exit_code",
    "pass_with_nonzero_exit_code",
    "qcl041_artifact_stdout_json_parse_failed",
    "Read-Qcl041AppFile",
    "Wait-Qcl041AppFile",
    "qcl041_app_file_read_timeout",
    "artifact_read",
    "qcl041_artifact_adb_read_timeout",
    "Start-Process",
    ...
    "owner_direct_p2p_sender_authority",
    "client_direct_p2p_sender_authority",
    "owner_direct_p2p_receiver_authority",
    "client_direct_p2p_receiver_authority",
    "direct_p2p_media_topology",
    "Get-Qcl100DirectP2pReceiverAuthority",
    "Get-Qcl100DirectP2pMediaTopologyAcceptance",
    "transport_server_bound_address",
    "transport_server_bound_interface",
    "qcl082_media_topology",
    "qcl082_media_topology_required",
    ...
    "same_group_duplex_claimed",
    "same_group_simultaneous_duplex",
    "same_group_rusty_direct_p2p_socket_authority_duplex_claimed",
    ...
    "full_stereo_required_for_qcl100_promotion",
