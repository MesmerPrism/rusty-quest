...
Assert-Contains "Media client" $client "SharedOfflineImmersiveMediaLibrary.snapshot("
Assert-Contains "Media client" $client "forceRefresh = true"
...
Assert-Contains "Activity panel binding" $activity "refreshSharedMediaLibraryFromPanel"
Assert-Contains "Activity live catalog" $activity "immersiveVideoPanelCoordinator.applyRefreshedCatalog("
Assert-NotContains "Activity live catalog" $activity "recreate()"
