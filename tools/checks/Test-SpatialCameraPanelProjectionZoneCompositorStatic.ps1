...
Assert-Contains $wsi "suppresses_same_surface_video(projection_zone_frame.settings, projection_zone_ready)" "The same-surface video draw must follow the alpha-capability-aware suppression policy."
