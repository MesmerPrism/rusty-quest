...
Assert-Contains $wsi "projectionZoneCompositeAlpha=" "Effective zone evidence must identify the selected swapchain alpha contract."
Assert-Contains $wsi "projectionZonePremultipliedAlphaOutput=" "Effective zone evidence must identify the shader output-alpha convention."
...
Assert-Contains $runtime "return Ok(self.projection_execution_available());" "Raw camera must skip guide draws while still authorizing the common projection-zone stage."
