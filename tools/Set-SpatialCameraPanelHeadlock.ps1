...
$properties = [ordered]@{
    enabled = "debug.rustyquest.spatial_camera_panel.panel.headlocked.enabled"
    offset_x_m = "debug.rustyquest.spatial_camera_panel.panel.headlocked.offset_x_m"
    offset_y_m = "debug.rustyquest.spatial_camera_panel.panel.headlocked.offset_y_m"
    distance_meters = "debug.rustyquest.spatial_camera_panel.panel.headlocked.distance_meters"
    width_meters = "debug.rustyquest.spatial_camera_panel.panel.headlocked.width_meters"
    height_meters = "debug.rustyquest.spatial_camera_panel.panel.headlocked.height_meters"
    scale = "debug.rustyquest.spatial_camera_panel.panel.headlocked.scale"
    joystick_enabled = "debug.rustyquest.spatial_camera_panel.panel.headlocked.joystick.enabled"
    joystick_translate_rate_mps = "debug.rustyquest.spatial_camera_panel.panel.headlocked.joystick.translate_rate_mps"
    joystick_distance_rate_mps = "debug.rustyquest.spatial_camera_panel.panel.headlocked.joystick.distance_rate_mps"
    joystick_scale_rate_per_second = "debug.rustyquest.spatial_camera_panel.panel.headlocked.joystick.scale_rate_per_second"
}
...
$tuningResult = Invoke-AdbCommand `
    ...
    -Arguments @("exec-out", "run-as", $PackageName, "cat", "files/spatial_camera_panel_headlock_tuning.json") `
    -AllowFailure
...
[pscustomobject]@{
    schema = "rusty.quest.spatial_camera_panel_panel_headlock_set.v1"
    serial = $Serial
    package_name = $PackageName
    cleared = [bool]$Clear
    applied = $applied
    readbacks = $readbacks
    tuning_file = "files/spatial_camera_panel_headlock_tuning.json"
