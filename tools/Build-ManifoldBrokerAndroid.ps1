...
if ($connectionHubSelected) {
    ...
    $connectionHubNativeConfig = [ordered]@{
        ...
        policy = [ordered]@{
            ...
            max_session_ttl_ms = if ($EnableConnectionHubDebugOperator) { 60000 } else { 2592000000 }
            ...
            authenticated_activity_session_ttl_ms = if ($EnableConnectionHubDebugOperator) { 60000 } else { 2592000000 }
        }
    }
}
