...
try {
    ...
    cargo test -p spatial-camera-panel-native-receipt camera_hwb_projection_freshness_runtime
    if ($LASTEXITCODE -ne 0) {
        throw "Spatial Camera Panel camera-HWB projection freshness runtime Rust tests failed."
    }
