...
$propertyName = "debug.rustyquest.spatial_camera_panel.particle_layer.surface_overscan_scale"
...
[pscustomobject]@{
    schema = "rusty.quest.spatial_camera_panel_particle_layer_overscan_set.v1"
    serial = $Serial
