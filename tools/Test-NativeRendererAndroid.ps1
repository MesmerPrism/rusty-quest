...
$videoProjectionStaticCheckPath = Join-Path $PSScriptRoot "checks\Test-NativeRendererVideoProjectionStatic.ps1"
...
& $videoProjectionStaticCheckPath -RepoRoot $repoRoot
