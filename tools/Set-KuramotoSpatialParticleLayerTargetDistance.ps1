...
$propertyName = "debug.rustyquest.kuramoto_spatial.particle_layer.target_distance_meters"
...
[pscustomobject]@{
    schema = "rusty.quest.kuramoto_spatial_particle_layer_target_distance_set.v1"
    serial = $Serial
