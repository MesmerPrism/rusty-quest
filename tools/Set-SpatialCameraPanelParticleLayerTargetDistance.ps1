...
$propertyName = "debug.rustyquest.spatial_camera_panel.particle_layer.target_distance_meters"
...
$clampedMeters = [Math]::Max(0.2, [Math]::Min(1.5, $Meters))
...
[pscustomobject]@{
    schema = "rusty.quest.spatial_camera_panel_particle_layer_target_distance_set.v1"
    serial = $Serial
